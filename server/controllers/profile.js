...
const updateProfile = async(req,res)=>{
     ...
     try{
        const profile = await Profile.findOneAndUpdate({userId: userId},{profileUrl,bio,website},{new: true}); 
        console.log(profile)
...
const updateFav = async(req,res)=>{
   ...
   try{
        ...
        const updated = await Profile.findOneAndUpdate({userId: req.userId}, profile, {new: true});
