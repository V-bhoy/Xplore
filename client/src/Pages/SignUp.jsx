            ...
            <MDBCardBody>
                <MDBValidation onSubmit={handleSubmit} noValidate className='row g-3'>
                     <div className="col-md-6">
                        <MDBInput value={firstName} label="First name" type="text" name="firstName" onChange={handleChange} required invalid validation="Please provide first name" />
                     </div>
                     <div className="col-md-6">
                        <MDBInput value={lastName} label="Last name" type="text" name="lastName" onChange={handleChange} required invalid validation="Please provide last name" />
                     </div>
