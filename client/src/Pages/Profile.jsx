    ...
    <>
      ...
      <MDBContainer className={Styles.main}>
        <MDBCard
          ...
          className={`${Styles.wrapper} d-flex flex-md-row justify-content-md-around`}
        >
          <div>
            <MDBCardImage
              src={profile?.profileUrl ? profile?.profileUrl : girl}
              alt="profile-url"
          ...
          <div>
            <MDBCardBody className="d-flex flex-column align-items-lg-start">
              <MDBCardTitle
                className="mb-4"
                style={{ color: "rgb(81, 65, 79)", fontWeight: "800" }}
              >
                <img src={emoji} alt="emoji" className={Styles.emoji} />
                <span className={Styles.heads}>Name &nbsp;- &nbsp;</span>{" "}
                {profile?.name}
              </MDBCardTitle>
              <MDBCardSubTitle
                className="mb-4"
              ...
              {profile?.bio ? (
                <>
                  {profile?.website ? (
                    ...
                    >
                      ...
                      <Link to={profile?.website}>Click to visit</Link>
                    </MDBCardText>
                  ) : null}
                  <MDBCardText
                    style={{ color: "rgb(81, 65, 79)", fontWeight: "800" }}
                ...
                <div
                  className={`d-flex justify-content-center align-items-center p-2 ${Styles.editBox}`}
                >
                  <div
                  ...
                  >
                    <p>
                      ...
                      <img src={sad} alt="" className={Styles.emojiSad} />
                    </p>
        ...
        <hr />
        <div className="mt-3">
          <h3 className="mb-4 pt-3" style={{ fontWeight: "bold" }}>
            {favs.length === 0 ? "You have no favourites!" : "Your Favourites"}
            <img
              style={{
                width: "48px",
                marginTop: "-0.8rem",
              ...
              src={favs.length === 0 ? sad : heartEye}
              alt="heart-eye"
            />
          </h3>
        </div>
