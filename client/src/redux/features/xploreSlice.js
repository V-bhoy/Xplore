...
export const createxplore = createAsyncThunk(
  "xplore/createxplore",
  async ({ updatedXploreData, navigate, toast }, { rejectWithValue }) => {
    try {
...
export const getxplore = createAsyncThunk(
  "xplore/getxplore",
...
export const getsinglexplore = createAsyncThunk(
  "xplore/getsinglexplore",
...
export const getuserxplore = createAsyncThunk(
  "xplore/getuserxplore",
  async (id, { rejectWithValue }) => {
    try {
...
export const deletexplore = createAsyncThunk(
  "xplore/deletexplore",
...
export const updatexplore = createAsyncThunk(
  "xplore/updatexplore",
  async ({ id, updatedXplore, toast, navigate }, { rejectWithValue }) => {
    try {
...
export const searchxplore = createAsyncThunk(
  "xplore/searchxplore",
...
export const tagxplore = createAsyncThunk(
  "xplore/tagxplore",
...
export const getrelatedxplore = createAsyncThunk(
  "xplore/getrelatedxplore",
...
export const likexplore = createAsyncThunk(
  "xplore/likexplore",
  async ({ id }, { rejectWithValue }) => {
    try {
...
const xploreSlice = createSlice({
  ...
  extraReducers: {
    ...
    [updatexplore.fulfilled]: (state, action) => {
      ...
      if (id) {
        state.userXplores = state.userXplores.map((elem) =>
          elem._id === id ? action.payload : elem
        );
        state.xplores = state.xplores.map((elem) =>
          elem._id === id ? action.payload : elem
        );
      }
    },
    ...
    [likexplore.fulfilled]: (state, action) => {
      ...
      if (id) {
        ...
        state.tagXplores = state.tagXplores.map((elem) =>
          elem._id === id ? action.payload : elem
        );
      }
    },
